...
import TelegramIcon from "@mui/icons-material/Telegram"; // ✅ NEW
...
export function FooterSocialLinks({ variant = "light", links }: Props) {
    const { twitter, facebook, instagram, youtube, google, telegram } = links;
    ...
    return (
        <FlexBox className="flex" mx={-0.625}>
            ...
            {telegram && <LinkItem variant={variant} Icon={TelegramIcon} url={telegram} />} {/* ✅ NEW */}
        </FlexBox>
    );
}
