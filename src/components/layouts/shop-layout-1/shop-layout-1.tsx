...
export default function ShopLayout1({ children, data }: Props) {
  ...
  const headerLogo = getServerImageUrl(
    shopData?.header_logo || header.logo,
    "300x120",
  );
  const mobileLogo = getServerImageUrl(
    shopData?.mobile_logo || mobileNavigation.logo,
    "300x120",
  );
  const footerLogo = getServerImageUrl(
    shopData?.footer_logo || footer.logo,
    "300x120",
  );
  ...
  const mobileNav = useMemo(
    () => [
      ...
      {
        title: t("nav.profile", t("dashboard.profile")),
        href: "/profile",
        icon: "User",
        badge: false,
      },
      ...
      <Fragment>
        ...
        <Footer1>
          <Footer1.Brand>
            ...
            <FooterApps
              playStoreUrl={
                shopData?.app_links?.google_play || footer.playStoreUrl
              }
              appleStoreUrl={
                shopData?.app_links?.app_store || footer.appStoreUrl
              }
            />
          </Footer1.Brand>
          ...
          <Footer1.Contact>
            <FooterContact
              ...
              address={
                shopData?.contact_info?.address || footer.contact.address
              }
            />
