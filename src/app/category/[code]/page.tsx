...
import { Container, Typography, Grid, Box, CircularProgress, Alert, Button, MenuItem, TextField, Card, CardContent, CardActionArea, Pagination } from '@mui/material';
...
export default function CategoryPage({ params }: { params: Promise<{ code: string }> }) {
  ...
  const { data, isLoading, error, refetch } = useCategoryProducts(code, { paged: page, count: itemsPerPage });
    ...
    <Container sx={{ py: 4 }}>
      ...
      <Box mb={4}>
        ...
        {subcategories.length > 0 && (
          <Box mt={3}>
            <Typography variant="h6" mb={2}>زیردستهها</Typography>
