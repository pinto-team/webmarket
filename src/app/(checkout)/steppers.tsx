...
const STEPPER_LIST = [
  { titleKey: "سبد خرید", disabled: false, path: "/cart" },
  { titleKey: "جزئیات", disabled: false, path: "/checkout" },
  { titleKey: "پرداخت", disabled: false, path: "/payment" },
  { titleKey: "بررسی", disabled: true, path: "/orders" }
];
