    ...
    fa: {
        translation: {
            ...
            products: {
                ...
                notFound: {
                    description: "متأسفانه محصول مورد نظر شما یافت نشد. ممکن است حذف شده یا آدرس اشتباه باشد.",
                ...
                itemsCountLabel_one: "{{count}} محصول",
                itemsCountLabel_other: "{{count}} محصول",
                sort: {
                    default: "پیش‌فرض",
                    highest: "گرانترین",
                    label: "مرتب‌سازی",
