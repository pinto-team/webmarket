...
import { ProductResource, BrandWithProducts, CategoryWithProducts, TagWithProducts, ProductFilters as ProductFiltersType } from "@/types/product.types";
...
export const productService = {
  ...
  async getCategories() {
    const response = await axiosInstance.get("/product-cats");
    return response.data.data;
  },
