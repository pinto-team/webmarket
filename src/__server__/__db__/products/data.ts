...
export const reviews = [
  {
    ...
    date: "2021-02-14",
    comment:
      "محصول عالی با کیفیت بسیار خوب. ارسال سریع و بستهبندی مناسب. حتما دوباره خرید میکنم."
  },
  {
    name: "علی رضایی",
    ...
    date: "2019-08-10",
    comment:
      "کاملا رضایت دارم. قیمت مناسب و کیفیت عالی. به دوستانم هم پیشنهاد دادم."
  },
  {
    name: "فاطمه محمدی",
    ...
    date: "2021-02-05",
    comment:
      "محصول مطابق توضیحات و تصاویر. خیلی راضی هستم از خریدم."
  }
];
